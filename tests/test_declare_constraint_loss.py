...
class MockSatisfiedLogicExpression(MockLogicExpression):
...
class MockViolatedLogicExpression(MockLogicExpression):
    def _condition(self, traces: Int[torch.Tensor, "batch activities"]) -> Bool[torch.Tensor, " batch"]:
...
class MockMixedLogicExpression(MockLogicExpression):
    def _condition(self, traces: Int[torch.Tensor, "batch activities"]) -> Bool[torch.Tensor, " batch"]:
...
class MockAlternatingLogicExpression(MockLogicExpression):
    sat = True
